...
export const SubscriptionHeroSection: FC<
      ...
      <div className="container mx-auto px-4 pt-40">
        <div className="mx-auto flex w-full flex-col items-center text-center">
          ...
          <h2 className="mb-6 max-w-2xl text-lg text-gray-600 md:text-xl">
            Desde la publicación hasta el cierre, optimiza cada paso del proceso
            con nuestras herramientas inteligentes basadas en AI. Todo lo que
            necesitas en un solo lugar para atraer clientes.
          </h2>
