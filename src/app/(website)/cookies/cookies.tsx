      ...
      <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <div className="mb-8 text-center sm:mb-12">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl px-4 text-base sm:px-0 sm:text-lg">
            En HomLista valoramos tu privacidad y queremos que entiendas cómo utilizamos las cookies
        ...
        <div className="mx-auto max-w-4xl space-y-6 sm:space-y-8">
          ...
          <Card className="border shadow-sm">
            <CardContent className="p-4 sm:p-6 lg:p-8">
              ...
              <p className="text-foreground text-sm leading-relaxed sm:text-base">
                ...
                dispositivo (ordenador, tablet o móvil) cuando visita un sitio web. Sirven para
                recordar sus preferencias, mejorar su experiencia de navegación y recopilar
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="border-secondary border-l-4 pl-4 sm:pl-6">
                  ...
                  <p className="text-foreground mb-3 text-sm sm:text-base">
                    Permiten analizar el uso del sitio (ej. páginas más visitadas, tiempo de
                    navegación).
                  </p>
                  <p className="text-foreground mb-2 text-sm sm:text-base">
                ...
                <div className="border-accent border-l-4 pl-4 sm:pl-6">
                  ...
                  <p className="text-foreground mb-2 text-sm sm:text-base">
                    Se usan para mostrarte anuncios personalizados dentro y fuera de HomLista.
                  </p>
                  <p className="text-foreground text-sm italic sm:text-base">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  ...
                  <ul className="text-foreground list-inside list-disc space-y-2 text-sm sm:text-base">
                    ...
                    <li>Puedes aceptar todas, rechazarlas o personalizarlas.</li>
                    <li>
                ...
                <div>
                  ...
                  <div className="bg-destructive/10 border-destructive/20 rounded-lg border p-3 sm:p-4">
                    <p className="text-foreground text-sm sm:text-base">
                      <>Ten en cuenta que </>
                      <strong>
                        bloquear cookies esenciales puede afectar el funcionamiento del sitio
                      </strong>
                      .
                    </p>
                  </div>
          ...
          <Card className="border shadow-sm">
            <CardContent className="p-4 sm:p-6 lg:p-8">
              ...
              <p className="text-foreground mb-4 text-sm sm:text-base">
                <>
                  Algunas cookies procesan datos fuera de México (principalmente en EE.UU.), en
                  servidores de proveedores como{" "}
                </>
                <strong>Google, Meta y Vercel</strong>.
              </p>
              <p className="text-foreground text-sm sm:text-base">
                <>HomLista garantiza que estas transferencias cumplen con las </>
                <strong>cláusulas contractuales tipo del RGPD</strong>, acuerdos equivalentes o
                medidas de seguridad compatibles con la LFPDPPP.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border shadow-sm">
            <CardContent className="p-4 sm:p-6 lg:p-8">
              ...
              <p className="text-foreground text-sm sm:text-base">
                Podemos actualizar esta política en cualquier momento. Las modificaciones
                sustanciales serán notificadas mediante el banner de cookies o por correo
        ...
        <div className="mt-8 px-4 text-center sm:mt-12">
          <p className="text-muted-foreground text-xs sm:text-sm">
            © 2025 HomLista - Haciendo que encontrar tu hogar ideal sea más fácil y personal
          </p>
        </div>
      </div>
    </div>
