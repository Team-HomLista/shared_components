        ...
        <div className="space-y-6">
          <div className="flex items-start gap-3">
            ...
            <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
              <strong>Cookies propias:</strong> gestionadas directamente por
              HomLista.
            </p>
          </div>
          <div className="flex items-start gap-3">
            ...
            <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
              <strong>Cookies de terceros:</strong> gestionadas por servicios
              como Google, Meta, Hotjar, etc., que pueden recopilar información
              sobre tu navegación y comportamiento para sus propias finalidades.
            </p>
          </div>
          <div className="border-muted/40 from-muted/20 to-muted/10 rounded-xl border bg-gradient-to-r p-6">
            <div className="flex items-start gap-4">
              ...
              <p className="text-foreground text-sm leading-relaxed font-medium sm:text-base">
                HomLista{" "}
                <strong>
                  no controla directamente los datos recopilados por terceros
                </strong>
