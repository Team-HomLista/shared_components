...
export const PropertyValidators = {
  ...
  isValidYear: (value: number | null | undefined): boolean => {
    ...
    return value >= 1800 && value <= currentYear + 10; // Allow future dates for planned construction
  },

  isValidFloor: (value: number | null | undefined): boolean => {
    return typeof value === "number" && value >= -10 && value <= 200; // Reasonable floor range
  },
} as const;
