          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
                ...
                <strong>información falsa o engañosa</strong>.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <XCircle className="text-destructive mt-0.5 h-4 w-4 flex-shrink-0" />
              <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
                Se publicaron{" "}
                <strong>fotos no relacionadas con bienes raíces</strong>.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <XCircle className="text-destructive mt-0.5 h-4 w-4 flex-shrink-0" />
            ...
            <div className="flex items-start gap-3">
              <XCircle className="text-destructive mt-0.5 h-4 w-4 flex-shrink-0" />
              <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
                Se ha utilizado activamente la plataforma (publicaciones,
                contactos, funciones premium).
              </p>
            </div>
          </div>
        </div>
