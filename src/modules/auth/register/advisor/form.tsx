  ...
  return (
    <Form {...form}>
      <form className="flex flex-col gap-4" onSubmit={form.handleSubmit(handleSubmit)}>
        ...
        <Text variant="subtitle">{t("register.professionalInfo")}</Text>

        <Form.Input
          control={form.control}
          name="agencyName"
          title={t("register.fields.agencyName")}
        />
        ...
        <Form.Input control={form.control} name="state" title={t("register.fields.state")} />

        <Form.Input
          control={form.control}
          name="addressLine"
          title={t("register.fields.addressLine")}
        />
        ...
        <div className="grid grid-cols-[auto_1fr_auto] gap-2">
          ...
          <Form.Input
            control={form.control}
            name="phoneExt"
            title={t("register.fields.phoneExt")}
            className="w-18"
          />
        </div>
