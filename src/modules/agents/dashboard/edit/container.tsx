...
export const AgentsEditContainer: FC<ContainerProps> = () => {
  return (
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
        ...
        <div className="lg:col-span-3">
          <TabsSection
            ...
            items={[
              { value: "general", label: "General", content: <GeneralTab mode="agent" /> },
        ...
        {/* Sidebar */}
        <AgencySidebar {...agencyMock.sidebar} showAgents={false} />
      </div>
    </section>
  );
};
