  ...
  return (
    <div className="flex flex-col px-4 sm:px-8">
      <div className="mx-auto flex w-full max-w-[1112px] flex-col gap-4 px-2 pt-8 md:px-0">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-grow">
                      <FormControl>
                        <Input placeholder="Buscar por palabras clave" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      <Select value={field.value || ""} onValueChange={field.onChange}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={BuildingType.DEPARTMENT}>Departamento</SelectItem>
        ...
        <div className="border-primary flex w-full border" />
