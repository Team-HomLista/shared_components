        ...
        <div className="space-y-6">
          ...
          <div className="border-destructive/10 from-destructive/5 to-destructive/10 rounded-xl border bg-gradient-to-r p-4 sm:p-6">
            <div className="mb-4 flex items-start gap-3">
              ...
              <h3 className="text-destructive text-base font-semibold sm:text-lg">Prohibiciones</h3>
            </div>
            <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
              Está <strong>prohibido copiar, modificar, reproducir o distribuir</strong> cualquier
          ...
          <div className="border-secondary/20 from-secondary/5 to-secondary/10 rounded-xl border bg-gradient-to-r p-4 sm:p-6">
            <div className="mb-4 flex items-start gap-3">
              ...
              <h3 className="text-secondary text-base font-semibold sm:text-lg">Licencia de Uso</h3>
            </div>
            <p className="text-foreground/80 text-sm leading-relaxed sm:text-base">
              Al publicar contenido (anuncios, fotos, descripciones), el usuario otorga a HomLista
              una <strong>licencia no exclusiva, transferible y sin costo</strong> para su uso en
          ...
          <div className="border-destructive/20 from-destructive/5 to-destructive/10 rounded-xl border bg-gradient-to-r p-6">
            <div className="flex items-start gap-4">
              ...
              <p className="text-foreground text-sm leading-relaxed font-medium sm:text-base">
                <strong>Advertencia:</strong> Cualquier uso no autorizado será perseguido conforme a
