      ...
      <CardContent className="p-6 sm:p-8 lg:p-10">
        ...
        <div className="space-y-4">
          <p className="text-foreground/80 text-base leading-relaxed sm:text-lg">
            Algunas cookies procesan datos fuera de México (principalmente en EE.UU.), en servidores
            de proveedores como <strong>Google, Meta y Vercel</strong>.
          </p>
          <p className="text-foreground/80 text-base leading-relaxed sm:text-lg">
            HomLista garantiza que estas transferencias cumplen con las{" "}
            <strong>cláusulas contractuales tipo del RGPD</strong>, acuerdos equivalentes o medidas
            de seguridad compatibles con la LFPDPPP.
          </p>
        </div>
      </CardContent>
    </Card>
