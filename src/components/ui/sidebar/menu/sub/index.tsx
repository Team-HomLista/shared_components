...
type SidebarMenuSubCompound = ForwardRefExoticComponent<
  ComponentPropsWithoutRef<"ul">
> &
  SidebarMenuSubComposition;
...
const ref = forwardRef<HTMLUListElement, React.ComponentProps<"ul">>(
  ({ className, ...props }, ref) => (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-black/50",
        "px-2.5 py-0.5",
