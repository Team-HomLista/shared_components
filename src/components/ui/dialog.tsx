  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background grid w-full gap-4 rounded-lg border p-8 shadow-lg duration-200",
      ...
      >
        ...
        {hideCloseButton && (
          <DialogPrimitive.Close
            className={cn(
              "ring-offset-background absolute top-3 right-3 rounded-full opacity-70 transition-opacity",
              "focus:ring-ring",
