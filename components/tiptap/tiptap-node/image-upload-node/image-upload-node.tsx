import { CloseIcon } from "@shared/components/tiptap/tiptap-icons/close-icon";
import "@shared/components/tiptap/tiptap-node/image-upload-node/image-upload-node.scss";
